        ...
        for item in items:
            ...
            results.append(
                Persona(
                    ...
                    why_different=_str(item.get("why_this_persona_is_different") or item.get("why_different")),
                    expected_behavior=_str(item.get("expected_behavior_or_need") or item.get("expected_behavior")),
